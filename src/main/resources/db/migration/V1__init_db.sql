...
CREATE TABLE `posts` (
  ...
  KEY `FK5lidm6cqbc7u4xhqpxm898qme` (`puser_id`),
  CONSTRAINT `FK5lidm6cqbc7u4xhqpxm898qme` FOREIGN KEY (`puser_id`) REFERENCES `users` (`id`),
...
CREATE TABLE `tag2post` (
  ...
  CONSTRAINT `FKpjoedhh4h917xf25el3odq20i` FOREIGN KEY (`post_id`) REFERENCES `posts` (`pid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `post_votes` (
  ...
  CONSTRAINT `FK9jh5u17tmu1g7xnlxa77ilo3u` FOREIGN KEY (`post_id`) REFERENCES `posts` (`pid`),
...
CREATE TABLE `post_comments` (
  ...
  CONSTRAINT `FKaawaqxjs3br8dw5v90w7uu514` FOREIGN KEY (`post_id`) REFERENCES `posts` (`pid`),
